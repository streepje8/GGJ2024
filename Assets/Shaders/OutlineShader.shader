//Based off https://github.com/TwoTailsGames/Unity-Built-in-Shaders/blob/master/DefaultResourcesExtra/Sprites-Default.shader
    ...
    SubShader
    {
        ...
        CGPROGRAM
			...
			float sobel (sampler2D tex, float2 uv) {
				...
				return sqrt(hr.a * hr.a + vt.a * vt.a);
			}
